...
class Banner extends CI_Controller {
	...
	private $mName = 'bannermodel';
	private $page_title = 'Manage Banner';
	private $add_title = 'Add Image';
	private $edit_title = 'Edit Image';
	private $PNotify_title = 'Banner Image';
	private $add_msg = 'Added Successfully';
	private $edit_msg = 'successfully Updated';
	...
	public function index()
	{
		...
		$curPage = floor(($this->input->post('pc')/$pp) + 1);
