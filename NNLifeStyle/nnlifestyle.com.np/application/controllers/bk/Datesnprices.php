...
class Datesnprices extends CI_Controller {
	
	private $folder = 'datesnprices';
	private $mName = 'dnpmodel';
	private $page_title = 'Manage Dates and Prices';
	private $add_title = 'Add Item';
	private $edit_title = 'Edit Item';
	private $PNotify_title = 'Dates and Prices';
	private $add_msg = 'Item Added Successfully';
	private $edit_msg = 'Item has been successfully Updated';
	...
	public function process(){
		...
		$data['pckgs'] = $this->common->get_list('packages');
		//additional code for category//
