...
class Wptestimonials extends CI_Controller {
	
	private $folder = 'wptestimonials';
	private $mName = 'testimodel';
	private $page_title = 'Testimonials';
	private $add_title = 'Add Testimonial';
	private $edit_title = 'Edit Testimonial';
	private $PNotify_title = 'Testimonials';
	private $add_msg = 'Testimonial Added Successfully';
	private $edit_msg = 'Testimonial has been successfully Updated';
