...
class Wbtags extends CI_Controller {
	
	private $folder = 'wbtags';
	private $mName = 'wbtagsmodel';
	private $page_title = 'Manage Tags';
	private $add_title = 'Add Tag';
	private $edit_title = 'Edit Tag';
	private $PNotify_title = 'Tags';
	private $add_msg = 'Tags Added Successfully';
	private $edit_msg = 'Tags has been successfully Updated';
