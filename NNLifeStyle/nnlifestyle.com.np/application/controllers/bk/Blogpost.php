...
class Blogpost extends CI_Controller {
	...
	private $folder = 'blogpost';
	private $mName = 'blogpostmodel';
	private $page_title = 'Manage Blogs';
	private $add_title = 'Add Post';
	private $edit_title = 'Edit Post';
	private $PNotify_title = 'Blog Post';
	private $add_msg = 'Post Added Successfully';
	private $edit_msg = 'Post has been successfully Updated';
	...
	public function process(){
		...
		$data['catdata'] = $this->common->get_list('blog_categories');
		$data['tagdata'] = $this->common->get_list('blog_tags');
		//additional code for category//
		$data['sdata'] = $this->{$this->mName}->get_selected_data();
