...
class Wpcategories extends CI_Controller {
	
	private $folder = 'wpcategories';
	private $mName = 'wpcatmodel';
	private $page_title = 'Manage Categories';
	private $add_title = 'Add Category';
	private $edit_title = 'Edit Category';
	private $PNotify_title = 'Categories';
	private $add_msg = 'Category Added Successfully';
	private $edit_msg = 'Category has been successfully Updated';
