...
class Wpdestination extends CI_Controller {
	
	private $folder = 'wpdestination';
	private $mName = 'wpdestimodel';
	private $page_title = 'Manage Destination';
	private $add_title = 'Add Destination';
	private $edit_title = 'Edit Destination';
	private $PNotify_title = 'Destination';
	private $add_msg = 'Destination Added Successfully';
	private $edit_msg = 'Destination has been successfully Updated';
	...
	public function process(){
		//additional code for packages//
		$data['packages'] = $this->common->get_list('packages');
		//additional code for packages//
