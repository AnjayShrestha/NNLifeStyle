...
class Wpregion extends CI_Controller {
	
	private $folder = 'wpregion';
	private $mName = 'wpregionmodel';
	private $page_title = 'Manage Region';
	private $add_title = 'Add Region';
	private $edit_title = 'Edit Region';
	private $PNotify_title = 'Region';
	private $add_msg = 'Region Added Successfully';
	private $edit_msg = 'Region has been successfully Updated';
	...
	public function process(){
		...
		$data['catdata'] = $this->common->get_list('destination');
		$data['subcatdata'] = $this->common->get_list('activities');
		//additional code for category//
