...
class Wpactivities extends CI_Controller {
	
	private $folder = 'wpactivities';
	private $mName = 'activitiesmodel';
	private $page_title = 'Manage Activities';
	private $add_title = 'Add Activity';
	private $edit_title = 'Edit Activity';
	private $PNotify_title = 'Activity';
	private $add_msg = 'Activity Added Successfully';
	private $edit_msg = 'Activity has been successfully Updated';
