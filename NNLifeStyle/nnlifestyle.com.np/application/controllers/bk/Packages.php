...
class Packages extends CI_Controller {
	...
	private $mName = 'packagesmodel';
	private $page_title = 'Manage Packages';
	private $add_title = 'Add Package';
	private $edit_title = 'Edit Package';
	private $PNotify_title = 'Package';
	private $add_msg = 'Package Added Successfully';
	private $edit_msg = 'Package has been successfully Updated';
	...
	public function process(){
		...
		$data['desdata'] = $this->common->get_list('destination');
		$data['catdata'] = $this->common->get_list('activities');
		$data['regdata'] = $this->common->get_list('region');
		//additional code for category//
