...
<h1>Shipping/ Delivery Address Details</h1>

<div class="usernav">
<ul>
	<li><b>Note:  </b> Shipping/ Delivery All fields are mandatory. </li>
</ul>
</div>
<!-- usernav -->
	...
	<div class="row">
		<div class="col-md-6">
			...
			<div class="span12 ">
				...
				<input class="form-control" type="text" id="shippingFullName" name="shippingFullName" placeholder="Enter your name" value="<?php echo $shippingFullName; ?>">
				</div>
			</div>
...
<!--j-row end-->
		...
		<div class="col-md-6 col-md-offset-6" >
			<div class="row">
				...
				<div class="col-md-6 cart_navigation">
					<a href="<?php echo base_url("cart"); ?>" class="btn btn-block" style="background: red;color: white;">&larr; Update Cart</a>
					
				</div>
				<div class="col-md-6" id="shippingUpdate">
					<button id="shipping" class="btn btn-block">Checkout &rarr;</button>
				</div>
			</div>	
		</div>
</div>
...
$(document).on('click', '#shipping', function () {
	...
	$.ajax({
		type: "POST",
		url: "<?php echo base_url("front/update_delivery"); ?>",
		data: dataString,
		beforeSend: function(){
