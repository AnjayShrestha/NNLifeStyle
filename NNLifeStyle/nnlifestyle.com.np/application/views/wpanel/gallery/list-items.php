	...
	<div class="row">
        ...
        <div class="col-md-10 col-md-offset-2">
            ...
            <div class="content">
                	...
                	<table class="table table-striped table-bordered table-hover">
                        ...
                        <div class="tt">
                          <tr>
                            ...
                            <td class="col-md-3"><?php echo $crow->title; ?></td>
                            ...
                            <td class="col-md-3"><?php echo $crow->packages; ?></td>
                ...
                <?php if(!empty($content) && empty($this->input->post('search'))){ ?>
                <div class="col-md-5">
	...
	$( ".myForm" ).validate( {
		rules: {
				...
				messages: {
					...
					packages: "Please select package"
				},
				errorElement: "em",
