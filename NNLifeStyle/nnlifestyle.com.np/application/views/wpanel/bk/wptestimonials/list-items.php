                	...
                	<table class="table table-striped table-bordered table-hover">
                        <thead>
                          <tr>
                            ...
                            <th class="col-md-2">Display Order</th>
                        ...
                        <div class="tt">
                          <tr>
                            ...
                            <td class="col-md-2"><?php echo $crow->fname; ?></td>
                            <td class="col-md-1"><div style="background-image:url(<?php echo $crow->attachment1; ?>); background-repeat:no-repeat; background-size:cover; background-position:center center; width:100%; height:60px;"></td>
                            <td class="col-md-2"><?php echo $crow->display_order; ?></td>
                            <td class="col-md-3">
								<p><?php echo $this->common->summaryModeb(strip_tags($crow->message), 10, "..."); ?></p>
                            </td>
                            <td class="col-md-1 text-center">
                            	<label class="switch">
								  <input class="status" name="status" id="<?php echo $crow->id; ?>" type="checkbox" <?php if($crow->status == 'Approved'){ echo 'checked';} ?>>
...
$(document).on('click', '.status', function(e){
	...
	$.ajax({
			...
			data:{"id":id, "process": "update", "status": cval},
