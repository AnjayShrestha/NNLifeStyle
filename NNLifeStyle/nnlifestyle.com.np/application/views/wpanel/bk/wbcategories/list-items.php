            ...
            <div class="content">
                ...
                <div class="col-md-12">
                	<table class="table table-striped table-bordered table-hover">
                        <thead>
                          <tr>
                          	<th class="col-md-1 text-center"><input name="checkAll" type="checkbox" id="checkAll"></th>
                            <th class="col-md-1">S.N.</th>
                            <th class="col-md-5">Title</th>
                            <th class="col-md-3">Display Order</th>
                            <th class="col-md-1 text-center">Dif</th>
                        ...
                        <div class="tt">
                          <tr>
                          	<td class="col-md-1 text-center"><input name="check[]" type="checkbox" id="check[]" class="check" value="<?php echo $crow->id; ?>" ></td>
                            <td class="col-md-1"><?php echo ++$c; ?></td>
                            <td class="col-md-5"><?php echo $crow->title; ?></td>
                            <td class="col-md-3"><?php echo $crow->display_order; ?></td>
                            <td class="col-md-1 text-center">
                            	<label class="switch">
								  <input class="status" name="status" id="<?php echo $crow->id; ?>" type="checkbox" <?php if($crow->display_in_front == 'Yes'){ echo 'checked';} ?>>
                ...
                <div class="col-md-5">
                	...
                	<p><strong>Note: Dih = Display In Front</strong></p>
...
$(document).on('click', '.status', function(e){
	...
	$.ajax({
			...
			data:{"id":id, "process": "update", "display_in_front": cval},
