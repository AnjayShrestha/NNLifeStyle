<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/css/travel/flaticon.css">
<style>
.admicon{font-size: 20px;}
            ...
            <div class="content">
                ...
                <div class="col-md-12">
                	<table class="table table-striped table-bordered table-hover">
                        <thead>
                          <tr>
                          	<th class="text-center"><input name="checkAll" type="checkbox" id="checkAll"></th>
                            <th>S.N.</th>
                            <th>Title</th>
							<th class="text-center">Image</th>
                            <th>Display Order</th>
                            <th>Tags</th>
                            <th class="text-center">Dih</th>
                        ...
                        <div class="tt">
                          <tr>
                          	<td class="text-center"><input name="check[]" type="checkbox" id="check[]" class="check" value="<?php echo $crow->id; ?>" ></td>
                            <td><?php echo ++$c; ?></td>
                            <td><?php echo $crow->title; ?></td>
							<td><div style="background-image:url(<?php echo $crow->attachment1; ?>); background-repeat:no-repeat; background-size:cover; background-position:center center; width:100%; height:60px;"></td>
                            <td><?php echo $crow->display_order; ?></td>
                            <td><?php echo $crow->tags; ?></td>
                            <td class="text-center">
                            	<label class="switch">
								  <input class="status" name="status" id="<?php echo $crow->id; ?>" type="checkbox" <?php if($crow->display_in_home == 'Yes'){ echo 'checked';} ?>>
                ...
                <div class="col-md-5">
                	...
                	<p class="note"><strong>Note: Dih = Display In Home</strong></p>
...
$(document).on('click', '.status', function(e){
	...
	$.ajax({
			...
			data:{"id":id, "process": "update", "display_in_home": cval},
